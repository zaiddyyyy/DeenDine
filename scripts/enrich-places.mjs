...
const RESTAURANTS = [
  ...
  { id: "vascos-peri-peri", name: "Vasco's Peri Peri", address: "440 E Roosevelt Rd, Lombard, IL 60148" },
  { id: "wing-zing", name: "Wing Zing", address: "821 E Roosevelt Rd, Lombard, IL 60148" },
  { id: "fyve-bros", name: "FYVE BROS", address: "1581 Bloomingdale Rd, Glendale Heights, IL 60139" },
  { id: "nazs-halal-food-lombard", name: "Naz's Halal Food", address: "30 W Roosevelt Rd, Lombard, IL 60148" },
  { id: "nyc-halal-eats", name: "NYC Halal Eats", address: "52 W Roosevelt Rd, Lombard, IL 60148" },
  { id: "addah", name: "Addah", address: "1300 S Main St U, Lombard, IL 60148" },
  { id: "milliy-family-restaurant", name: "Milliy Family Restaurant", address: "1279 Rickert Dr, Naperville, IL 60540" },
  { id: "daves-hot-chicken-naperville", name: "Dave's Hot Chicken", address: "2736 Showplace Dr, Naperville, IL 60564" },
  { id: "sabri-nihari", name: "Sabri Nihari Restaurant", address: "2502 W Devon Ave, Chicago, IL 60659" },
  { id: "khan-bbq", name: "Khan B.B.Q. Restaurant", address: "2401 W Devon Ave, Chicago, IL 60659" },
  { id: "pita-inn", name: "Pita Inn", address: "4710 Dempster St, Skokie, IL 60076" },
  { id: "halal-guys-wabash", name: "The Halal Guys", address: "172 N Wabash Ave, Chicago, IL 60601" },
  { id: "halal-guys-lasalle", name: "The Halal Guys", address: "100 N LaSalle St, Chicago, IL 60602" },
  { id: "halal-guys-division", name: "The Halal Guys", address: "49 W Division St, Chicago, IL 60610" },
  { id: "habibis-chicken-falafel", name: "Habibi's Chicken & Falafel", address: "421 N Harlem Ave, Oak Park, IL 60301" },
  { id: "taza-mediterranean", name: "Taza Mediterranean Cuisine", address: "176 N Franklin St, Chicago, IL 60606" },
  { id: "nile-of-hyde-park", name: "The Nile of Hyde Park", address: "1162 E 55th St, Chicago, IL 60615" },
  { id: "jerusalem-cafe-grill", name: "Jerusalem Cafe Grill Restaurant", address: "1030 Lake St, Oak Park, IL 60301" },
  { id: "epic-burger-state-st", name: "Epic Burger", address: "517 S State St, Chicago, IL 60605" },
  { id: "epic-burger-pearson-st", name: "Epic Burger", address: "40 E Pearson St, Chicago, IL 60611" },
